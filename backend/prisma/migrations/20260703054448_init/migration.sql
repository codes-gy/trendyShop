...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CARD', 'TRANSFER', 'VIRTUAL_ACCOUNT', 'POINT');

-- CreateEnum
CREATE TYPE "DeliveryStatus" AS ENUM ('PREPARING', 'DISPATCHED', 'IN_TRANSIT', 'DELIVERED');
...
-- CreateIndex
CREATE INDEX "Product_isAvailable_deletedAt_idx" ON "Product"("isAvailable", "deletedAt");
